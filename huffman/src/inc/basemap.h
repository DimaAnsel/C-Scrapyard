...
uint64_t one_hot_parse_compressed_idx(uint64_t*, uint8_t**, uint8_t*, uint8_t, uint64_t, uint8_t);
...
uint64_t fix_depth_tree_parse_compressed_idx(uint64_t*, uint8_t**, uint8_t*, uint8_t, uint64_t, uint8_t);
...
uint64_t log_depth_tree_parse_compressed_idx(uint64_t*, uint8_t**, uint8_t*, uint8_t, uint64_t, uint8_t);
